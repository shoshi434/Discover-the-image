...
const planetImage=document.querySelectorAll(".planetImage")
...
let index =currentUser.index2+1// אינדקס של מערך השאלות
...
const changeImg=()=>{//פונקציה שמחליפה תמונה 
   let randomPicture=Math.floor(Math.random()*planetImage.length)
   let selectedImage = planetImage[randomPicture].src
